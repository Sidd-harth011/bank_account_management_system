...
void openAccount(Account user)
{
    ...
    ofstream outfile("C:\\Users\\Siddharth\\Desktop\\C++ Projects\\bank_account_management_system\\B_A_M_S.txt", ios::app);
    if (!outfile)
    {
...
void addCash()
{
    ...
    ifstream infile("C:\\Users\\Siddharth\\Desktop\\C++ Projects\\bank_account_management_system\\B_A_M_S.txt");
    ofstream outfile("C:\\Users\\Siddharth\\Desktop\\C++ Projects\\bank_account_management_system\\B_A_M_S_1.txt");
    if (!infile || !outfile)
    {
        cout << "\tError: File Can't Open!" << endl;
    }
    ...
    outfile.close();
    infile.close();
    remove("C:\\Users\\Siddharth\\Desktop\\C++ Projects\\bank_account_management_system\\B_A_M_S.txt");
    rename("C:\\Users\\Siddharth\\Desktop\\C++ Projects\\bank_account_management_system\\B_A_M_S_1.txt", "C:\\Users\\Siddharth\\Desktop\\C++ Projects\\bank_account_management_system\\B_A_M_S.txt");
    Sleep(5000);
}
